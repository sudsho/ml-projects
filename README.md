...
|---------|-------------|--------|
| [Byte-Pair Encoding Tokenizer from Scratch](./bpe-tokenizer/) | Subword BPE tokenizer in pure Python - corpus prep, greedy most-frequent-pair merges, encoder/decoder with round-trip tests | 🔄 In Progress |
